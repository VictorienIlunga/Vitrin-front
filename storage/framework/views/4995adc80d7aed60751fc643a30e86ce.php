...
<header class="fixed top-0 left-0 right-0 z-40">
           ...
           <div class=" flex flex-row">
             ...
             <ul class="navbar bg-white lg:bg-transparent w-full hidden text-center lg:text-left lg:flex lg:flex-row text-gray-900 text-sm items-center font-bold">
               <li class="relative hover:text-black">
                 <a class="active block py-3 lg:py-7 px-6 border-b-2 border-transparent" href="<?php echo e(route('accueil')); ?>#hero">Accueil</a>
               </li>
               <li class="relative hover:text-black">
                 <a class="block py-3 lg:py-7 px-6 border-b-2 border-transparent" href="<?php echo e(route('accueil')); ?>#services">Services</a>
               </li>
               <li class="relative hover:text-black">
                 <a class="block py-3 lg:py-7 px-6 border-b-2 border-transparent" href="<?php echo e(route('accueil')); ?>#portfolio">Realisations</a>
               </li>
               <li class="relative hover:text-black">
                <a class="block py-3 lg:py-7 px-6 border-b-2 border-transparent" href="<?php echo e(route('apropos')); ?>">A propos</a>
              </li>
 ...
 </header><!-- end header --><?php /**PATH C:\xampp\htdocs\vitrines\resources\views/layouts/navigation-site.blade.php ENDPATH**/ ?>