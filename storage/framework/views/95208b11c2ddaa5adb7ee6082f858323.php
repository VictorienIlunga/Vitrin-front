...
<div class="container">
    ...
    <p>Monsieur <?php echo e(Auth::user()->name); ?></p>
    en son nom.
    <p><?php echo e(Auth::user()->Adresse); ?></p>
    ...
    <p>
        Et : <strong><?php echo e($credit->client->nom); ?> <?php echo e($credit->client->prenom); ?></strong>, résidant à <?php echo e($credit->client->adresse); ?>,
    ...
    <p><strong>PREAMBULE :</strong><br/><br/>
        ...
        L’EMPRUNTEUR est une personne morale Ayant comme profession <?php echo e($credit->client->prenom); ?>

      
        Par le présent contrat le PRETEUR met à disposition de l’EMPRUNTEUR une somme
        de <strong><?php echo e(number_format($credit->montant, 2, '.', ' ')); ?>Fbu</strong>,
    ...
    <p>
        ...
        Le PRETEUR accorde et consent à l’EMPRUNTEUR un prêt d’un montant de : <strong><?php echo e(number_format($credit->montant, 2, '.', ' ')); ?>Fbu</strong> Ledit prêt est d’une durée de <?php echo e(App\Http\Controllers\CreditController::interet($credit->id)[2]); ?> jours</strong>.
    </p>

    
    <p>
        <strong>ARTICLE 2 : DATE DE DEBUT DU PRET ET DEBOURSEMENT DES FONDS</strong><br/><br/>
        La date de début du prêt est le <?php echo e($credit->created_at->format('d/m/Y')); ?>.
    ...
    <p>
        ...
        L’EMPRUNTEUR remboursera le montant total du prêt, avec les intérêts y afférents ;<br/> soit <strong><?php echo e(number_format($credit->montant+App\Http\Controllers\CreditController::interet($credit->id)[0], 2, '.', ' ')); ?>Fbu</strong>,
        en une échéance au terme prévu du prêt le <?php echo e($credit->DateFin); ?>.
         ...
         Les intérêts sont calculés quotidiennement sur la base du capital restant dû à la fin de chaque journée,
          en considérant que chaque jour a une durée égale.
           Les intérêts accumulés seront versés en une seule fois à l'échéance du prêt,
            lors du remboursement du capital emprunté. Sur une période de <?php echo e(App\Http\Controllers\CreditController::interet($credit->id)[2]); ?> jours, 
            le taux d’intérêt total serait calculé en multipliant le montant emprunté par le taux quotidien,
            puis en multipliant le résultat par le nombre de jours,ce qui correspond à <strong><?php echo e(App\Http\Controllers\CreditController::interet($credit->id)[1]); ?>%</strong>
    </p>
    ...
    <p>
        ...
        L’EMPRUNTEUR laisse comme gage <strong><?php echo e($credit->gage); ?></strong>
    ...
    <p>
        Fait  à bujumbura, le <?php echo e($credit->created_at->format('d/m/Y')); ?>  
    </p>
    ...
    <div class="d11">
        ...
        <p><strong><?php echo e($credit->client->nom); ?> <?php echo e($credit->client->prenom); ?></strong></p>
...
<?php /**PATH C:\xampp\htdocs\octogone finance\resources\views/pdf/contratpdf.blade.php ENDPATH**/ ?>