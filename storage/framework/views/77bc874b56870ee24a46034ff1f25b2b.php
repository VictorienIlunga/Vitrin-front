<section>
    ...
    <form method="post" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" class="w-full h-full mt-6 space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div id="add-img" class="w-full h-auto flex md:hidden flex-col justify-center items-center">
            <div class="w-28 h-28 sm:w-32 sm:h-32 lg:w-40 lg:h-40 flex justify-center items-center rounded-full border border-gray-600 bg-gray-300">
                ...
                <img id="svg-img" src="<?php echo e(asset('storage/profil/'.Auth::user()->image)); ?>" class="w-full h-full rounded-full object-cover">  
                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\myAdmin\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>