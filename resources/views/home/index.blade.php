...
@section('content')
    ...
    <div id="hero" class="section relative z-0 py-16 md:pt-32 md:pb-20 bg-gray-50/80">
        <div class="container xl:max-w-6xl mx-auto px-4">
            ...
            <div class="flex-shrink max-w-full px-4 sm:px-12 lg:px-18 w-full sm:w-9/12 lg:w-1/2 self-center">
                <img src="{{asset('img/dummy/hero.svg')}}" class="w-full max-w-full h-auto" alt="creative agency">
            </div><!-- end content -->
    ...
    <div id="portfolio" class="section relative z-0 py-12 md:py-16 bg-white">
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s">
            ...
            <a href="{{asset('img/dummy/img1.jpg')}}" data-gallery="gallery1" data-glightbox="title: My title; description: This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img1.jpg')}}" alt="Image Description">
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
            <div class="relative overflow-hidden cursor-pointer mb-6">
            <a href="{{asset('img/dummy/img2.jpg')}}" data-gallery="gallery1" data-glightbox="title: My title; description: This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img2.jpg')}}" alt="Image Description">
                <div class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
            <div class="relative overflow-hidden cursor-pointer mb-6">
            <a href="{{asset('img/dummy/img3.jpg')}}" data-gallery="gallery1" data-glightbox="title: My title; description: This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img3.jpg')}}" alt="Image Description">
                <div class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
            <div class="relative overflow-hidden cursor-pointer mb-6">
            <a href="{{asset('img/dummy/img4.jpg')}}" data-gallery="gallery1" data-glightbox="title: My title; description:  This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img4.jpg')}}" alt="Image Description">
                <div class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 class="text-base leading-normal font-semibold my-1 text-white">Logo Design</h3>
                <small class="d-block">Branding</small>
                </div>
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
            <div class="relative overflow-hidden cursor-pointer mb-6">
            <a href="{{asset('img/dummy/img5.jpg')}}" data-gallery="gallery1" data-glightbox="title: My title; description:  This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img5.jpg')}}" alt="Image Description">
                <div class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 class="text-base leading-normal font-semibold my-1 text-white">Web Development</h3>
                <small class="d-block">Web</small>
                </div>
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s">
            <div class="relative overflow-hidden cursor-pointer mb-6">
            <a href="{{asset('img/dummy/img6.jpg')}}" data-gallery="gallery1" data-glightbox="title: Graphic Design; description: This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img6.jpg')}}" alt="Image Description">
                <div class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 class="text-base leading-normal font-semibold my-1 text-white">Graphic Design</h3>
                <small class="d-block">Graphic</small>
                </div>
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
            <div class="relative overflow-hidden cursor-pointer mb-6">
            <a href="{{asset('img/dummy/img7.jpg')}}" data-gallery="gallery1" data-glightbox="title: Logo Design; description: This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img7.jpg')}}" alt="Image Description">
                <div class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 class="text-base leading-normal font-semibold my-1 text-white">Logo Design</h3>
                <small class="d-block">Branding</small>
                </div>
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
            <div class="relative overflow-hidden cursor-pointer mb-6">
            <a href="{{asset('img/dummy/img8.jpg')}}" data-gallery="gallery1" data-glightbox="title: Web Development; description: This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img8.jpg')}}" alt="Image Description">
                <div class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 class="text-base leading-normal font-semibold my-1 text-white">Web Development</h3>
                <small class="d-block">Web</small>
                </div>
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
            <div class="relative overflow-hidden cursor-pointer mb-6">
            <a href="{{asset('img/dummy/img9.jpg')}}" data-gallery="gallery1" data-glightbox="title: Graphic Design; description: This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img9.jpg')}}" alt="Image Description">
                <div class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                <h3 class="text-base leading-normal font-semibold my-1 text-white">Graphic Design</h3>
                <small class="d-block">Graphic</small>
                </div>
        ...
        <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
            <div class="relative overflow-hidden cursor-pointer mb-6">
            <a href="{{asset('img/dummy/img10.jpg')}}" data-gallery="gallery1" data-glightbox="title: App Design; description: This is a wider card with supporting text below as a natural lead-in to additional content" class="glightbox3">
                <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125" src="{{asset('img/dummy/img10.jpg')}}" alt="Image Description">
                <div class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                    ...
                    <div class="splide__list grayscale">
                        <div class="splide__slide">
                            <div class="w-full px-4 text-center pb-3">
                                ...
                                <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="{{asset('')}}img/dummy/img1.png" alt="Image Description">
                                </a>
                            </div>
                        </div>
                        <div class="splide__slide">
                            <div class="w-full px-4 text-center pb-3">
                                <a href="#" target="_blank">
                                <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="{{asset('')}}img/dummy/img2.png" alt="Image Description">
                                </a>
                            </div>
                        </div>
                                    <div class="splide__slide">
                                    <div class="w-full px-4 text-center pb-3">
                                        <a href="#" target="_blank">
                                        <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="{{asset('')}}img/dummy/img3.png" alt="Image Description">
                                        </a>
                                    </div>
                                    </div>
                                    <div class="splide__slide">
                                    <div class="w-full px-4 text-center pb-3">
                                        <a href="#" target="_blank">
                                        <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="{{asset('')}}img/dummy/img4.png" alt="Image Description">
                                        </a>
                                    </div>
                                    </div>
                                    <div class="splide__slide">
                                    <div class="w-full px-4 text-center pb-3">
                                        <a href="#" target="_blank">
                                        <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="{{asset('')}}img/dummy/img5.png" alt="Image Description">
                                        </a>
                                    </div>
                                    </div>
                                    <div class="splide__slide">
                                    <div class="w-full px-4 text-center pb-3">
                                        <a href="#" target="_blank">
                                        <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto" src="{{asset('')}}img/dummy/img6.png" alt="Image Description">
                                        </a>
                                    </div>
                                    </div>
                                </div>
            ...
            <div class="flex flex-wrap flex-row -mx-4 justify-center">
                <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                    ...
                    <div class="relative overflow-hidden px-6">
                        <img src="{{asset('')}}img/dummy/avatar1.png" class="max-w-full h-auto mx-auto rounded-full bg-gray-50/80 grayscale" alt="title image">
                    </div>
                ...
                <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                    ...
                    <div class="relative overflow-hidden px-6">
                        <img src="{{asset('')}}img/dummy/avatar3.png" class="max-w-full h-auto mx-auto rounded-full bg-gray-50/80 grayscale" alt="title image">
                    </div>
                    <div class="pt-6 text-center">
                ...
                <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                    ...
                    <div class="relative overflow-hidden px-6">
                        <img src="{{asset('')}}img/dummy/avatar2.png" class="max-w-full h-auto mx-auto rounded-full bg-gray-50/80 grayscale" alt="title image">
                    </div>
                    <div class="pt-6 text-center">
                ...
                <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                    ...
                    <div class="relative overflow-hidden px-6">
                        <img src="{{asset('img/dummy/avatar4.png')}}" class="max-w-full h-auto mx-auto rounded-full bg-gray-50/80 grayscale" alt="title image">
                    </div>
                    <div class="pt-6 text-center">
