<div class="w-full flex flex-col items-center mt-4 ">
    <div class="w-[98%] h-10 flex bg-white rounded-md text-[15px] ">
        ...
        <div class="ml-8 flex items-center justify-center">
            Fiche de <span class="ml-2 font-semibold">{{$client->nom}} {{$client->prenom}}</span>
        </div>
    </div>
    <div class="w-[98%] h-auto flex bg-white rounded-md mt-2">
        ...
        <div class="w-full md:w-[25%] h-auto flex flex-col items-center justify-center md:justify-start">
            <div class="w-11/12 md:w-full h-auto  space-y-1 flex flex-col items-center justify-center md:items-start">
                ...
                <div class="pl-2 flex items-center @if($client->statut=='Anormal') bg-red-500 text-white @else bg-gray-200 text-black @endif w-[200px] h-8 rounded-md mt-4">
        ...
        <div class="w-full md:w-[35%] h-auto flex flex-col items-center md:items-start space-y-2 mt-2 md:mt-0">
            ...
            <div onclick="confirmation({{$client->id}})" class="w-11/12 md:w-[80%] xl:w-80 h-10 cursor-pointer rounded-md border bg-[#8259fd] text-white flex justify-center items-center space-x-1">
                <div>
   ...
   @if ($client->credit->count()>0)
        <div class="w-[98%] h-auto flex flex-col bg-white justify-center items-center rounded-md my-2  pt-2">
            ...
            @include('profileUser.partial.recent')
        </div>    
...
@include('profileUser.partial.addCredit')
@include('confirmation.payementConfirmation')
@include('confirmation.confirmation')
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                if(response.result=='add'){
                    showPorfiles('{{$client->id}}','profile')
