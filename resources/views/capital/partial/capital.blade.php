                            ...
                            <div  class="w-full h-auto flex justify-between items-center space-x-2  ">
                                <div class="w-full h-auto flex items-center space-x-2 ">
                                    <div class="w-20 h-20 rounded-full overflow-hidden bg-gray-200">
                                        <img src="{{asset('storage/profil/'.Auth::user()->image)}}" class="w-full h-full object-cover">
                                    </div>
                                    <div class="w-60 h-[60px] space-y-1">
                                        <div class="w-[60%] h-6 rounded-xl bg-gray-200 flex justify-center items-center">{{Auth::user()->name}}</div>
                                        <div class="w-[100%] h-6 rounded-xl bg-gray-200 flex justify-center items-center">{{Auth::user()->email}}</div>
                                    </div>
                                </div>
